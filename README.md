...
これは[OpenAI Realtime API](https://platform.openai.com/docs/guides/realtime)を[WebRTC](https://platform.openai.com/docs/guides/realtime-webrtc)と共に使用するサンプルアプリケーションです。
...
MIT
# openai-realtime-console-20250306-cursor-demo
